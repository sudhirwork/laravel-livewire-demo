        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <p>Current Image:</p>
                    @if ($currentImage)
                        <img src="{{ $currentImage }}" alt="{{ $feature_image }}">
                    @endif
                    <div class="form-group mb-2">
                        <label for="feature_image">Update Image:</label>
            ...
            <div class="modal-footer mt-3">
                <button wire:click.prevent="updateBlog()" class="btn btn-dark">Update</button>
                <button wire:click.prevent="doClose()" class="btn btn-danger">Cancel</button>
            </div>
        </div>
    </div>
</div>
